...
//        $datumok = $start->format('Y-m-d');
        $sql = "INSERT INTO `keresek`(`szemely_id`, `datum`, `statusz`, `allapot`) VALUES ('" . $_SESSION['szemely_id'] . "','$start','$tavollet','elinditva');";
    } else {
        ...
        foreach ($period as $date) {
            ...
            echo $datumok;
            echo "<br>";
            $napok[] = "('" . $_SESSION['szemely_id'] . "','$datumok','$tavollet','elinditva')";
        }
        $sql .= join(',', $napok);
